...
$upload_dir = $dirs . "cms_rap" . $dirs . "uploads" . $dirs;  // path from base_url to upload base dir
$current_path = ".." . $dirs . ".." . $dirs . ".." . $dirs . ".." . $dirs . "uploads"; // relative path from filemanager folder to upload files folder
